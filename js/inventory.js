...
W.Inv = (function() {
  ...
  var ORDER = ['wood', 'stone', 'fiber', 'berry', 'flint', 'meat', 'hide', 'cooked', 'arrow', 'mushroom', 'metal', 'soup'];
  var LABEL = { wood: '木材', stone: '石頭', fiber: '纖維', berry: '漿果', flint: '燧石', meat: '生肉', hide: '毛皮', cooked: '烤肉', arrow: '箭矢', mushroom: '夜光蘑菇', metal: '金屬錠', soup: '蘑菇湯' };
  var ICON  = { wood: '\uD83E\uDEB5', stone: '\uD83E\uDEA8', fiber: '\uD83C\uDF3F', berry: '\uD83E\uDED0', flint: '\u26CF\uFE0F', meat: '\uD83E\uDD69', hide: '\uD83D\uDFEB', cooked: '\uD83C\uDF57', arrow: '\u27A4', mushroom: '\uD83C\uDF44', metal: '\uD83D\uDD29', soup: '\uD83C\uDF72' };

  var items = { wood: 0, stone: 0, fiber: 0, berry: 0, flint: 0, meat: 0, hide: 0, cooked: 0, arrow: 0, mushroom: 0, metal: 0, soup: 0 };
